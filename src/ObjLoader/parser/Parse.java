...
public class Parse {
    ...
    private void processVertex(String line) {
        ...
        builder.addVertexGeometric(values[0], values[1], values[2],VertexGCount);
        VertexGCount ++;
    }
...
//        System.err.println("Parsed as "+parsedList);
    ...
    private void parseMtlFile(String mtlFilename) throws FileNotFoundException, IOException {
        ...
        while (true) {
            ...
            // @ TODO add function to handle MTL_ke
            else if (line.startsWith(MTL_Ke)) {
                continue;
            }
